...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware',  # для Django Debug Toolbar
]
...
DATABASES = {
    ...
    #         'USER': 'postgres',
    #         'PASSWORD': 'admin',
    #         'HOST': 'localhost',  # Или IP адрес сервера БД, если он установлен не локально
    #         'PORT': 5432,  # Пусто или стандартный порт PostgreSQL 5432
    #     }
}
